/*
 * Windows NTSTATUS codes for radare2
 *
 * Usage: to types/windows/ntstatus.h
 *        te ntstatus
 *        te ntstatus 0xC0000005    # Returns STATUS_ACCESS_VIOLATION
 *
 * Common NTSTATUS values from NT kernel
 */
